...
"""
    SLCETools.VASP.read_poscar(path) -> Crystal
...
"""
    SLCETools.VASP.write_poscar(path, crystal; comment = "…", cartesian = false)
...
function write_poscar(path::AbstractString, crystal::Crystal;
                      comment::AbstractString = "generated by SLCETools",
...
"""
    SLCETools.VASP.write_incar(path, directions; magmoms = nothing, base = nothing,
...
function write_incar(path::AbstractString, directions::AbstractMatrix{<:Real};
    ...
    lines = String[]
    if base === nothing
        push!(lines, "# constrained-noncollinear INCAR generated by SLCETools.VASP")
...
"""
    SLCETools.VASP.write_inputs(dir, crystal, config; magmoms = nothing, base = nothing,
                               constrain = true, saxis = nothing,
                               comment = "generated by SLCETools", kwargs...)
    SLCETools.VASP.write_inputs(rootdir, crystal, configs; prefix = "config", kwargs...)
...
function write_inputs(dir::AbstractString, crystal::Crystal, config::AbstractMatrix{<:Real};
                      magmoms = nothing, base = nothing, comment = "generated by SLCETools",
                      kwargs...)
