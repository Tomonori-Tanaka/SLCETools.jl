# Oracle: the from-scratch VASP POSCAR / OSZICAR parsers in `SCETools.VASP` agree bit-for-bit
...
@testset "SCETools.jl oracle" begin
    @testset "VASP POSCAR / OSZICAR parsing vs Magesty" begin
        ...
        write(poscar,
            "FePt\n1.0\n 3.1 0.2 0.0\n 0.0 3.0 0.0\n 0.0 0.0 4.0\nFe Pt\n1 1\nDirect\n 0.1 0.2 0.3\n 0.5 0.5 0.5\n")
        mr = SCETools.VASP.read_poscar(poscar)
        ...
        mrd = read_configs(SCETools.VASP.Oszicar(osz))[1]
